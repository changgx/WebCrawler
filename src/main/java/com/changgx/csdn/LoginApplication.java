...
public class LoginApplication {
	...
	public static void main(String[] args) throws Exception {
		login("2210840161@qq.com", "fight2016");
	}
	...
	public static DefaultHttpClient login(String username,String password) throws Exception {
		...
		/*初始cookie*/
		String cookie = "_jc_save_detail=true; _jc_save_showZtkyts=true;_jc_save_fromDate=2016-12-16" +
				";_jc_save_fromStation=%u5317%u4EAC%2CBJP;_jc_save_toDate=2016-12-16;" +
				"_jc_save_toStation=%u4E0A%u6D77%2CSHH;_jc_save_wfdc_flag=dc;" +
		...
		if(rindex!=-1){
			...
			jsurl = "https://kyfw.12306.cn/otn/resources/merged/login_js.js";
		...
		/*  写入硬盘 */
		File storeFile = new File("F:\\12306.jpg");
